...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'Sub Optimal Re-eval')
    custom_group.add_argument("--enable", help="enable Sub Optimal Re-eval",
                              default=None, action="store_true",dest="enable_suboptimal")
    custom_group.add_argument("--disable", help="disable Sub Optimal Re-eval",
                              default=None, action="store_false",dest="enable_suboptimal")
    ...
    custom_group.add_argument("--site_file", help="site list file. Each site name on a different line",
                              default=None, action="store",dest="site_file")
